...
class Apilot(Plugin):
    ...
    def on_handle_context(self, e_context: EventContext):
        ...
        if content.startswith(trigger_prefix) != True:
            return
        content = e_context["context"].content[1:].strip()
    ...
    def get_help_text(self, verbose=False, **kwargs):
        ...
        # 娱乐和信息类
        help_text += "\n🎉 娱乐与资讯：\n"
        help_text += f"  🌅 早报: 发送“{trigger_prefix}早报”获取早报。\n"
        help_text += f"  🐟 摸鱼: 发送“{trigger_prefix}摸鱼”获取摸鱼人日历。\n"
        help_text += f"  🔥 热榜: 发送“{trigger_prefix}xx热榜”查看支持的热榜。\n"
        help_text += f"  🔥 八卦: 发送“{trigger_prefix}八卦”获取明星八卦。\n"

        # 查询类
        help_text += "\n🔍 查询工具：\n"
        help_text += f"  🌦️ 天气: 发送“{trigger_prefix}城市+天气”查天气，如“北京天气”。\n"
        help_text += f"  📦 快递: 发送“{trigger_prefix}快递+单号”查询快递状态。如“快递112345655”\n"
        help_text += f"  🌌 星座: 发送星座名称查看今日运势，如“{trigger_prefix}白羊座”。\n"
